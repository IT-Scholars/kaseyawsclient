 ...
 */
            ...
            /**
            *  AddTicRequestResponse bean class
            */
        
        public  class AddTicRequestResponse extends kaseyaws.ResponseBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AddTicRequestResponse
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localNewId ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localNewIdTracker = false ;
                           ...
                           */
                           public  java.lang.String getNewId(){
                            ...
                            /**
                               ...
                               * @param param NewId
                               */
                               public void setNewId(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localNewIdTracker = true;
                                       } else {
                                          localNewIdTracker = false;
                                              
                                       }
                                   
                                            this.localNewId=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddTicRequestResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                if (localNewIdTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"newId", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"newId");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("newId");
                                    }
                                          ...
                                          if (localNewId==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("newId cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localNewId);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","AddTicRequestResponse"));
                 if (localNewIdTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "newId"));
                                 
                                        if (localNewId != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNewId));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("newId cannot be null!!");
                                        }
                                    } if (localMethodTracker){
    ...
    public static class Factory{
        ...
        */
        public static AddTicRequestResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddTicRequestResponse object =
                new AddTicRequestResponse();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddTicRequestResponse".equals(type)){
                                ...
                                return (AddTicRequestResponse)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","newId").equals(reader.getName())){
