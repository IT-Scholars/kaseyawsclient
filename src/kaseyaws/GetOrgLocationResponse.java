 ...
 */
            ...
            /**
            *  GetOrgLocationResponse bean class
            */
        
        public  class GetOrgLocationResponse extends kaseyaws.ResponseBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetOrgLocationResponse
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for OrgLocation
                        */

                        
                                    protected kaseyaws.OrgLocation localOrgLocation ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localOrgLocationTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return kaseyaws.OrgLocation
                           */
                           public  kaseyaws.OrgLocation getOrgLocation(){
                               return localOrgLocation;
                           }
                            ...
                            /**
                               ...
                               * @param param OrgLocation
                               */
                               public void setOrgLocation(kaseyaws.OrgLocation param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localOrgLocationTracker = true;
                                       } else {
                                          localOrgLocationTracker = false;
                                              
                                       }
                                   
                                            this.localOrgLocation=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetOrgLocationResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localOrgLocationTracker){
                                            if (localOrgLocation==null){
                                                 throw new org.apache.axis2.databinding.ADBException("orgLocation cannot be null!!");
                                            }
                                           localOrgLocation.serialize(new javax.xml.namespace.QName("KaseyaWS","orgLocation"),
                                               factory,xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","GetOrgLocationResponse"));
                 if (localOrgLocationTracker){
                            elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                    ...
                                    elementList.add(localOrgLocation);
                                } if (localMethodTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "Method"));
    ...
    public static class Factory{
        ...
        */
        public static GetOrgLocationResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOrgLocationResponse object =
                new GetOrgLocationResponse();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetOrgLocationResponse".equals(type)){
                                ...
                                return (GetOrgLocationResponse)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","orgLocation").equals(reader.getName())){
                                
                                                object.setOrgLocation(kaseyaws.OrgLocation.Factory.parse(reader));
