 ...
 */
            ...
            /**
            *  DeleteAgentRequest bean class
            */
        
        public  class DeleteAgentRequest extends kaseyaws.RequestBase
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localAgentGuid ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAgentGuidTracker = false ;
                           ...
                           */
                           public  java.lang.String getAgentGuid(){
                            ...
                            /**
                               ...
                               */
                               public void setAgentGuid(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAgentGuidTracker = true;
                                       } else {
                                          localAgentGuidTracker = false;
                        ...
                        /**
                        * field for UninstallAgentFirst
                        */

                        
                                    protected boolean localUninstallAgentFirst ;
                           ...
                           * @return boolean
                           */
                           public  boolean getUninstallAgentFirst(){
                               return localUninstallAgentFirst;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param UninstallAgentFirst
                               */
                               public void setUninstallAgentFirst(boolean param){
                            
                                            this.localUninstallAgentFirst=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DeleteAgentRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteAgentRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteAgentRequest",
                                        ...
                                        xmlWriter.writeStartElement("AgentGuid");
                                          ...
                                          if (localAgentGuid==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localAgentGuid);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"UninstallAgentFirst", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"UninstallAgentFirst");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("UninstallAgentFirst");
                                    }
                                
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("UninstallAgentFirst cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUninstallAgentFirst));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","DeleteAgentRequest"));
                 if (localAgentGuidTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUninstallAgentFirst));
                             if (localBrowserIPTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "BrowserIP"));
    ...
    public static class Factory{
        ...
        */
        public static DeleteAgentRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteAgentRequest object =
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteAgentRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteAgentRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","UninstallAgentFirst").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setUninstallAgentFirst(
