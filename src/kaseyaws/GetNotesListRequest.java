 ...
 */
            ...
            /**
            *  GetNotesListRequest bean class
            */
        
        public  class GetNotesListRequest extends kaseyaws.RequestBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetNotesListRequest
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for AddedSince
                        */

                        
                                    protected java.lang.String localAddedSince ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAddedSinceTracker = false ;
                           ...
                           */
                           public  java.lang.String getAddedSince(){
                               return localAddedSince;
                           }
                            ...
                            /**
                               ...
                               * @param param AddedSince
                               */
                               public void setAddedSince(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAddedSinceTracker = true;
                                       } else {
                                          localAddedSinceTracker = false;
                                              
                                       }
                                   
                                            this.localAddedSince=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetNotesListRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetNotesListRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetNotesListRequest",
                ...
                if (localAddedSinceTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"AddedSince", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"AddedSince");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("AddedSince");
                                    }
                                

                                          if (localAddedSince==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("AddedSince cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localAddedSince);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","GetNotesListRequest"));
                 if (localAddedSinceTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "AddedSince"));
                                 
                                        if (localAddedSince != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAddedSince));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("AddedSince cannot be null!!");
                                        }
                                    } if (localBrowserIPTracker){
    ...
    public static class Factory{
        ...
        */
        public static GetNotesListRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetNotesListRequest object =
                new GetNotesListRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetNotesListRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetNotesListRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","AddedSince").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setAddedSince(
