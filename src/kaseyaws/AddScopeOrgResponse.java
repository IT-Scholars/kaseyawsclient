 ...
 */
            ...
            /**
            *  AddScopeOrgResponse bean class
            */
        
        public  class AddScopeOrgResponse extends kaseyaws.ResponseBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AddScopeOrgResponse
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.math.BigDecimal localOrgOutId ;
                           ...
                           */
                           public  java.math.BigDecimal getOrgOutId(){
                               return localOrgOutId;
                           }
                            ...
                            /**
                               ...
                               * @param param OrgOutId
                               */
                               public void setOrgOutId(java.math.BigDecimal param){
                            
                                            this.localOrgOutId=param;
                        ...
                        */
                                    ...
                                    protected java.lang.String localOrgOutRef ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localOrgOutRefTracker = false ;
                           ...
                           */
                           public  java.lang.String getOrgOutRef(){
                               return localOrgOutRef;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param OrgOutRef
                               */
                               public void setOrgOutRef(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localOrgOutRefTracker = true;
                                       } else {
                                          localOrgOutRefTracker = false;
                                              
                                       }
                                   
                                            this.localOrgOutRef=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddScopeOrgResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AddScopeOrgResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AddScopeOrgResponse",
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"orgOutId", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"orgOutId");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("orgOutId");
                                    }
                                

                                          if (localOrgOutId==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("orgOutId cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrgOutId));
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                              if (localOrgOutRefTracker){
                                    namespace = "KaseyaWS";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"orgOutRef", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"orgOutRef");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("orgOutRef");
                                    }
                                

                                          if (localOrgOutRef==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("orgOutRef cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localOrgOutRef);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","AddScopeOrgResponse"));
                
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "orgOutId"));
                                 
                                        if (localOrgOutId != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrgOutId));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("orgOutId cannot be null!!");
                                        }
                                     if (localOrgOutRefTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                        ...
                                        if (localOrgOutRef != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrgOutRef));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("orgOutRef cannot be null!!");
                                        }
                                    } if (localMethodTracker){
    ...
    public static class Factory{
        ...
        */
        public static AddScopeOrgResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddScopeOrgResponse object =
                new AddScopeOrgResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddScopeOrgResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddScopeOrgResponse)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","orgOutId").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","orgOutRef").equals(reader.getName())){
