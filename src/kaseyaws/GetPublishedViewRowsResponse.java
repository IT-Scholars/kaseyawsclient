...
/**
 * GetPublishedViewRowsResponse.java
 *
 ...
 */
            ...
            /**
            *  GetPublishedViewRowsResponse bean class
            */
        
        public  class GetPublishedViewRowsResponse extends kaseyaws.ResponseBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetPublishedViewRowsResponse
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for PublishedViewRows
                        */

                        
                                    protected java.lang.String localPublishedViewRows ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPublishedViewRowsTracker = false ;
                           ...
                           */
                           public  java.lang.String getPublishedViewRows(){
                               return localPublishedViewRows;
                           }
                            ...
                            /**
                               ...
                               * @param param PublishedViewRows
                               */
                               public void setPublishedViewRows(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localPublishedViewRowsTracker = true;
                                       } else {
                                          localPublishedViewRowsTracker = false;
                                              
                                       }
                                   
                                            this.localPublishedViewRows=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetPublishedViewRowsResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localPublishedViewRowsTracker){
                                    namespace = "KaseyaWS";
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"PublishedViewRows", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"PublishedViewRows");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("PublishedViewRows");
                                    }
                                

                                          if (localPublishedViewRows==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("PublishedViewRows cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localPublishedViewRows);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","GetPublishedViewRowsResponse"));
                 if (localPublishedViewRowsTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "PublishedViewRows"));
                                 
                                        if (localPublishedViewRows != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPublishedViewRows));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("PublishedViewRows cannot be null!!");
                                        }
                                    } if (localMethodTracker){
    ...
    public static class Factory{
        ...
        */
        public static GetPublishedViewRowsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPublishedViewRowsResponse object =
                new GetPublishedViewRowsResponse();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPublishedViewRowsResponse".equals(type)){
                                ...
                                return (GetPublishedViewRowsResponse)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","PublishedViewRows").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setPublishedViewRows(
