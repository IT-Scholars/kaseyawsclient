...
/**
 * LockFunctionAccessRequest.java
 *
 ...
 */
            ...
            /**
            *  LockFunctionAccessRequest bean class
            */
        
        public  class LockFunctionAccessRequest extends kaseyaws.RequestBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = LockFunctionAccessRequest
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localBaseRole ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBaseRoleTracker = false ;
                           ...
                           */
                           public  java.lang.String getBaseRole(){
                            ...
                            /**
                               ...
                               */
                               public void setBaseRole(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localBaseRoleTracker = true;
                                       } else {
                                          localBaseRoleTracker = false;
                                              
                                       }
                                   
                                            this.localBaseRole=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       LockFunctionAccessRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LockFunctionAccessRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LockFunctionAccessRequest",
                           xmlWriter);
                   }

                if (localBaseRoleTracker){
                                    namespace = "KaseyaWS";
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"BaseRole", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"BaseRole");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("BaseRole");
                                    }
                                

                                          if (localBaseRole==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("BaseRole cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localBaseRole);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","LockFunctionAccessRequest"));
                 if (localBaseRoleTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "BaseRole"));
                                 
                                        if (localBaseRole != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBaseRole));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("BaseRole cannot be null!!");
                                        }
                                    } if (localRoleNameTracker){
    ...
    public static class Factory{
        ...
        */
        public static LockFunctionAccessRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LockFunctionAccessRequest object =
                new LockFunctionAccessRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LockFunctionAccessRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LockFunctionAccessRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","BaseRole").equals(reader.getName())){
