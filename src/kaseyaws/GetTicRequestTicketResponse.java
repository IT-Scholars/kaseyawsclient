...
/**
 * GetTicRequestTicketResponse.java
 *
 ...
 */
            ...
            /**
            *  GetTicRequestTicketResponse bean class
            */
        
        public  class GetTicRequestTicketResponse extends kaseyaws.ResponseBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetTicRequestTicketResponse
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetTicRequestTicketResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","GetTicRequestTicketResponse"));
                 if (localTicketIdTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "ticketId"));
                                 
                                        if (localTicketId != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTicketId));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("ticketId cannot be null!!");
                                        }
                                    } if (localMethodTracker){
    ...
    public static class Factory{
        ...
        */
        public static GetTicRequestTicketResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTicRequestTicketResponse object =
                new GetTicRequestTicketResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetTicRequestTicketResponse".equals(type)){
                                ...
                                return (GetTicRequestTicketResponse)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
