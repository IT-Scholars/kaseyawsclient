 ...
 */
            ...
            /**
            *  CreateRoleRequest bean class
            */
        
        public  class CreateRoleRequest extends kaseyaws.RequestBase
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for ParentRoleName
                        */

                        
                                    protected java.lang.String localParentRoleName ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localParentRoleNameTracker = false ;
                           ...
                           */
                           public  java.lang.String getParentRoleName(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ParentRoleName
                               */
                               public void setParentRoleName(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localParentRoleNameTracker = true;
                                       } else {
                                          localParentRoleNameTracker = false;
                                              
                                       }
                                   
                                            this.localParentRoleName=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CreateRoleRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreateRoleRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreateRoleRequest",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"RoleType", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"RoleType");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("RoleType");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ParentRoleName", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ParentRoleName");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ParentRoleName");
                                    }
                                

                                          if (localParentRoleName==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("ParentRoleName cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localParentRoleName);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","CreateRoleRequest"));
                 if (localRoleNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                        ...
                                        if (localRoleType != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRoleType));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("RoleType cannot be null!!");
                                        }
                                    } if (localParentRoleNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                        ...
                                        if (localParentRoleName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localParentRoleName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("ParentRoleName cannot be null!!");
                                        }
                                    } if (localBrowserIPTracker){
    ...
    public static class Factory{
        ...
        */
        public static CreateRoleRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreateRoleRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateRoleRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","RoleName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","RoleType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","ParentRoleName").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setParentRoleName(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
