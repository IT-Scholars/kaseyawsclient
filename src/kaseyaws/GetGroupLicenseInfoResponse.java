...
/**
 * GetGroupLicenseInfoResponse.java
 *
 ...
 */
            ...
            /**
            *  GetGroupLicenseInfoResponse bean class
            */
        
        public  class GetGroupLicenseInfoResponse extends kaseyaws.ResponseBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetGroupLicenseInfoResponse
                           ...
                           */
                           public  int getMaxAgents(){
                            ...
                            /**
                               ...
                               * @param param MaxAgents
                               */
                               public void setMaxAgents(int param){
                            
                                            this.localMaxAgents=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetGroupLicenseInfoResponse.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"MaxAgents", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"MaxAgents");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("MaxAgents");
                                    }
                                
                                               if (localMaxAgents==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("MaxAgents cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaxAgents));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","GetGroupLicenseInfoResponse"));
                
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "MaxAgents"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaxAgents));
                             if (localMethodTracker){
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "Method"));
    ...
    public static class Factory{
        ...
        */
        public static GetGroupLicenseInfoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetGroupLicenseInfoResponse object =
                new GetGroupLicenseInfoResponse();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetGroupLicenseInfoResponse".equals(type)){
                                ...
                                return (GetGroupLicenseInfoResponse)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","MaxAgents").equals(reader.getName())){
