...
/**
 * MoveMachineToAnotherGroupRequest.java
 *
 ...
 */
            ...
            /**
            *  MoveMachineToAnotherGroupRequest bean class
            */
        
        public  class MoveMachineToAnotherGroupRequest extends kaseyaws.RequestBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = MoveMachineToAnotherGroupRequest
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for OtherMachineGroupGuid
                        */

                        
                                    protected java.math.BigDecimal localOtherMachineGroupGuid ;
                           ...
                           * @return java.math.BigDecimal
                           */
                           public  java.math.BigDecimal getOtherMachineGroupGuid(){
                               return localOtherMachineGroupGuid;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param OtherMachineGroupGuid
                               */
                               public void setOtherMachineGroupGuid(java.math.BigDecimal param){
                            
                                            this.localOtherMachineGroupGuid=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       MoveMachineToAnotherGroupRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MoveMachineToAnotherGroupRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MoveMachineToAnotherGroupRequest",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"OtherMachineGroupGuid", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"OtherMachineGroupGuid");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("OtherMachineGroupGuid");
                                    }
                                

                                          if (localOtherMachineGroupGuid==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("OtherMachineGroupGuid cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOtherMachineGroupGuid));
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","MoveMachineToAnotherGroupRequest"));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                                                      "OtherMachineGroupGuid"));
                                 
                                        if (localOtherMachineGroupGuid != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOtherMachineGroupGuid));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("OtherMachineGroupGuid cannot be null!!");
                                        }
                                     if (localBrowserIPTracker){
    ...
    public static class Factory{
        ...
        */
        public static MoveMachineToAnotherGroupRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MoveMachineToAnotherGroupRequest object =
                new MoveMachineToAnotherGroupRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MoveMachineToAnotherGroupRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MoveMachineToAnotherGroupRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","OtherMachineGroupGuid").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setOtherMachineGroupGuid(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDecimal(content));
