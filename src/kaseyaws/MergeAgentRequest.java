 ...
 */
            ...
            /**
            *  MergeAgentRequest bean class
            */
        
        public  class MergeAgentRequest extends kaseyaws.RequestBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = MergeAgentRequest
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for OfflineAgentGuid
                        */

                        
                                    protected java.math.BigDecimal localOfflineAgentGuid ;
                           ...
                           * @return java.math.BigDecimal
                           */
                           public  java.math.BigDecimal getOfflineAgentGuid(){
                               return localOfflineAgentGuid;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param OfflineAgentGuid
                               */
                               public void setOfflineAgentGuid(java.math.BigDecimal param){
                            
                                            this.localOfflineAgentGuid=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       MergeAgentRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MergeAgentRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MergeAgentRequest",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"OfflineAgentGuid", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"OfflineAgentGuid");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("OfflineAgentGuid");
                                    }
                                

                                          if (localOfflineAgentGuid==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("OfflineAgentGuid cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOfflineAgentGuid));
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","MergeAgentRequest"));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                        ...
                                        if (localOfflineAgentGuid != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOfflineAgentGuid));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("OfflineAgentGuid cannot be null!!");
                                        }
                                     if (localBrowserIPTracker){
    ...
    public static class Factory{
        ...
        */
        public static MergeAgentRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MergeAgentRequest object =
                new MergeAgentRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MergeAgentRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MergeAgentRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","OfflineAgentGuid").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setOfflineAgentGuid(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToDecimal(content));
