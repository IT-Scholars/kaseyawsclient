 ...
 */
            ...
            /**
            *  GetMachineListRequest bean class
            */
        
        public  class GetMachineListRequest extends kaseyaws.RequestBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetMachineListRequest
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for MachineCollection
                        */

                        
                                    protected java.lang.String localMachineCollection ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMachineCollectionTracker = false ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getMachineCollection(){
                               return localMachineCollection;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MachineCollection
                               */
                               public void setMachineCollection(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localMachineCollectionTracker = true;
                                       } else {
                                          localMachineCollectionTracker = false;
                                              
                                       }
                                   
                                            this.localMachineCollection=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetMachineListRequest.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetMachineListRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localMachineGroupTracker){
                             ...
                             } if (localMachineCollectionTracker){
                                    namespace = "KaseyaWS";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"MachineCollection", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"MachineCollection");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("MachineCollection");
                                    }
                                

                                          if (localMachineCollection==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("MachineCollection cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localMachineCollection);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("KaseyaWS","GetMachineListRequest"));
                 if (localMachineGroupTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("KaseyaWS",
                                        ...
                                        if (localMachineCollection != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMachineCollection));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("MachineCollection cannot be null!!");
                                        }
                                    } if (localBrowserIPTracker){
    ...
    public static class Factory{
        ...
        */
        public static GetMachineListRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMachineListRequest object =
                new GetMachineListRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetMachineListRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMachineListRequest)kaseyaws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("KaseyaWS","MachineCollection").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMachineCollection(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
